            ...
            <Card className="h-50h dark">
              <Table isStriped removeWrapper className="dark"
                ...
                <TableHeader className="dark">
                    <TableColumn key="position" allowsSorting align="center">#</TableColumn>
                    <TableColumn key="playerName" allowsSorting align="center">ACCOUNT</TableColumn>
                    <TableColumn key="score" allowsSorting align="center">TIME</TableColumn>
